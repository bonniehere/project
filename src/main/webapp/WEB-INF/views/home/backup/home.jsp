...
<head>
	...
	<link rel="stylesheet" href="../../resources/css/constant01_main.css" />
	...
	<style>
			 ...
			 .mid_search_wrap .search_form_tit:before{display: block;position: absolute;left: 0;top: 50%;transform: translateY(-50%);background: url(/common/front/url(../../../../resources/img//images/icon/ico_main_search.png) no-repeat center center; width: 20px;height: 20px;content: '';}
...
<!-- 팝업존 -->
	<div class="popupzone_wrap">
		<div class="popupzone_content swiper-container swiper-container-initialized swiper-container-horizontal">
	        ...
	        <a href="https://gh.cauhs.or.kr/home/board/boardClinicalList.do"><img src="../../resources/img/slide4.png" alt="팝업이미지"></a>
	        </li>
            ...
            <div class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 4"></span></div>
				<div class="swiper-button-prev swiper-button-disabled" tabindex="0" role="button" aria-label="Previous slide" aria-disabled="true">
					<img src="../../resources/img/arrow_left.png">
				</div>
				<div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-disabled="false">
					<img src="../../resources/img/arrow_right.png">
				</div>
...
<h3 class="tit"><span>병원알림</span></h3>
    ...
    <ul class="notice_list" id="notice_list_0" style="display: none;">                                	
		...
		<span class="tit">"복막으로 퍼진 위암도 항암제 뿌려 작게… 수술까지 합니다"</span>
		<span class="ssum">
		...
		<span class="info">
        	<em class="date">2023-12-04</em>
            <em class="press">헬스조선</em>
		...
		<li class="sty3">
		<a href="https://v.daum.net/v/20231204120803048" target="_blank">
		<span class="tit">생간·육회·민물고기 함부로 먹으면 큰 탈</span>
		<span class="ssum">
		...
		<li class="sty3">
		<a href="https://www.k-health.com/news/articleView.html?idxno=68649" target="_blank">
		...
		<span class="info">
        <em class="date">2023-12-04</em>
        <em class="press">헬스경향</em>
        <em class="press" style="margin-left:10px;"></em>
        </span>
        </a>
        </li>
		<li class="sty3">
		<a href="https://www.khanews.com/news/articleView.html?idxno=226615" target="_blank">
		<span class="tit">중앙대광명병원, ‘2023 새빛음악회’ 성료</span>
		<span class="ssum">
		<img src="/common/front/home/images/common/emptyimg.png" alt="병원로고">
		</span>
        ...
        <ul class="notice_list" id="notice_list_1" style="display: block;">
            ...
            <li class="sty1">
	        <a href="javascript:void(0);" onclick="javascript:fn_Detail('201000000','','2','1402');">
	        <span class="tit">중앙대의료원 후원자 초청 ‘Appreciation Day’ 행사 성료</span>
	        <span class="dec">- 1억 원 이상 발전기금 후원자 모임 'Honors Club', 통합 모금 캠페인에 크게 기여 중앙대학교의료원(의료원장 홍창권)이 지난 9일 롯데 시그니엘 서울 호텔에서 1억 원 이상의 고액 후원자 ‘Honors(아너스)'를 초청해 존경과 감사의 마음을 전하는 ‘Appreciation Day’ 행사를 개최했다.중앙대의료원은 바이오 메디컬 분야 발전 재원 마련을 위해 2021년 중앙대학교와 함께 ‘중앙 Medical Innovation 위원회’를 설립하고 ‘의료혁신의 중앙, 당신으로부터 출발합니다’를 캐치프레이즈로 대학과 의료원이 함께 총 4년간</span>
	        <span class="photo"><img src="/_upload/board_2/7d6127b1-f588-45d0-8960-f42638c8b9d6" alt="이미지"></span>
...
<!-- // 병원알림 -->
	...
	<!-- 건강영상 -->
		...
		<ul class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
			<li class="swiper-slide swiper-slide-active" style="width: 241.5px; margin-right: 13px;">
		<div class="card_box">
		...
		<li class="swiper-slide swiper-slide-next" style="width: 241.5px; margin-right: 13px;">
		<div class="card_box">
		...
		<li class="swiper-slide" style="width: 241.5px; margin-right: 13px;">
		<div class="card_box">
		...
		<li class="swiper-slide" style="width: 241.5px; margin-right: 13px;">
		<div class="card_box">
		<a href="javascript:void(0);" onclick="javascript:fn_Detail('201000000','','49','145');">
		<p class="photo"><img src="/_upload/board_49/7eb8aaa0-c4aa-4c98-bc2c-26b7586f55fd" alt="이미지" style="width: 270px; height: 152px;"></p>
		<p class="tit">위암 3기의 싱가포르 의사: 국경을 넘은 한국의 의료</p>
		<p class="dec"></p>
		</a>
		<p class="chip_wrap">
		</p>
		...
		<li class="swiper-slide" style="width: 241.5px; margin-right: 13px;">
		<div class="card_box">
		<a href="https://youtu.be/1gfe8Fe_ltk?si=OOLQgVRyT5mukoOG" class="" target="_blank">
		<p class="photo"><img src="/_upload/board_49/107659b4-78c0-4ab9-b751-89f9447b18d8" alt="이미지" style="width: 270px; height: 152px;"></p>
		<p class="tit">환절기에 조심해야 할 질환들</p>
		<p class="dec"></p>
		</a>
		<p class="chip_wrap">
		</p>
		...
		<li class="swiper-slide" style="width: 241.5px; margin-right: 13px;">
		<div class="card_box">
		<a href="https://www.mbn.co.kr/vod/programContents/previewlist/927/5923/1340234" class="" target="_blank">
		<p class="photo"><img src="/_upload/board_49/f61ea8ab-a5a2-4a82-b094-8336b4a92dc7" alt="이미지" style="width: 270px; height: 152px;"></p>
		<p class="tit">노년 비극의 시작, 새는 근육을 지켜라!</p>
		<p class="dec"></p>
		</a>
		<p class="chip_wrap">
		</p>
		...
		<div class="swiper-scrollbar"><div class="swiper-scrollbar-drag" style="transform: translate3d(0px, 0px, 0px); width: 119.158px;"></div></div>
		<span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
        </div>
        <!-- // 건강정보 -->
        </div>
	...
	<!-- 안내 레이어팝업 -->
			...
			<div class="layer_wrap bh_main_open_event_pop" style="display: none;">
				...
				<div class="layer_inner">
					...
					<img src="/_upload/popup/7c91fd2b-1272-4b07-8398-836c92c63867" style="width: 500px;">
					</a>
					<a href="https://www.youtube.com/@aftertherainkr" target="_blank">
					<img src="/_upload/popup/426ebb63-cae8-4354-86d5-b9d26493103d" style="width: 500px;">
					</a>
					</div>
